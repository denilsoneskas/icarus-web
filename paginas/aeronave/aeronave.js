...
function criaLinha(aeronave) {
  ...
  var editAeronave = '<button class="btn btn-info btn-sm" onClick=habilitaEditarAeronave('+aeronave.id+')>Editar</button>'
  var delAeronave = '<button class="btn btn-danger btn-sm" onClick=deletarAeronave('+aeronave.id+')>Remover</button>'
