...
function criaLinha(piloto) {
  ...
  var editPiloto = '<button class="btn btn-info btn-sm" onClick=habilitaEditarPiloto('+piloto.id+')>Editar</button>'
  var delPiloto = '<button class="btn btn-danger btn-sm" onClick=deletarPiloto('+piloto.id+')>Remover</button>'
