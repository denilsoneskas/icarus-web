...
function criaLinha(fabricante) {
  ...
  var editFabricante = '<button class="btn btn-info btn-sm" onClick=habilitaEditarFabricante('+fabricante.id+')>Editar</button>'
  var delFabricante = '<button class="btn btn-danger btn-sm" onClick=deletarFabricante('+fabricante.id+')>Remover</button>'
