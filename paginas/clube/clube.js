...
function criaLinha(clube) {
  ...
  var editClube = '<button class="btn btn-info btn-sm" onClick=habilitaEditarClube('+clube.id+')>Editar</button>'
  var delClube = '<button class="btn btn-danger btn-sm" onClick=deletarClube('+clube.id+')>Remover</button>'
