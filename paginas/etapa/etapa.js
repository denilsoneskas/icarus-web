...
function criaLinha(etapa) {
  ...
  var decolar = '<button class="btn btn-primary btn-sm" id=decolar'+etapa.id+' onClick=decolarPiloto('+etapa.id+')>Decolar</button>'
  var pousar = '<button class="btn btn-success btn-sm" id=pousar'+etapa.id+' onClick=pousarPiloto('+etapa.id+')>Pousar</button>'
  var distancia = '<button class="btn btn-secondary btn-sm" id=distancia'+etapa.id+' onClick=distanciaMosca('+etapa.id+')>Distancia</button>'
  var delEtapa = '<button class="btn btn-danger btn-sm" onClick=deletarEtapa('+etapa.id+')>Remover</button>'
